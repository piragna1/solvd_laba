...
console.log("Input Array 1:", JSON.stringify(array3, null, 2));
console.log("Input Array 2:", JSON.stringify(array4, null, 2));
...
console.log("Input Array 1:", JSON.stringify(array5, null, 2));
console.log("Input Array 2:", JSON.stringify(array6, null, 2));
...
console.log("Input Array 1:", JSON.stringify(array7, null, 2));
console.log("Input Array 2:", JSON.stringify(array8, null, 2));
...
console.log("Input Array 1:", JSON.stringify(unionArray1, null, 2));
console.log("Input Array 2:", JSON.stringify(unionArray2, null, 2));
console.log("👉 Output:", JSON.stringify(unionResult1, null, 2), '\n');
...
console.log("Input Array 1:", JSON.stringify(unionArray1, null, 2));
console.log("Input Array 2: []");
console.log("👉 Output:", JSON.stringify(unionResult2, null, 2), '\n');
...
console.log("Input Array 1:", JSON.stringify(dupArray1, null, 2));
console.log("Input Array 2:", JSON.stringify(dupArray2, null, 2));
console.log("👉 Output:", JSON.stringify(unionResult3, null, 2), '\n');
...
console.log("- First 5 elements:", JSON.stringify(unionResult4.slice(0, 5), null, 2));
console.log("- Last 5 elements:", JSON.stringify(unionResult4.slice(-5), null, 2));
...
console.log("Input Array 1:", JSON.stringify(nestedArray1, null, 2));
console.log("Input Array 2:", JSON.stringify(nestedArray2, null, 2));
console.log("👉 Output:", JSON.stringify(unionResult5, null, 2), '\n');
...
console.log("Input Array 1:", JSON.stringify(primitivesArray1, null, 2));
console.log("Input Array 2:", JSON.stringify(primitivesArray2, null, 2));
console.log("👉 Output:", JSON.stringify(unionResult6, null, 2), '\n');
...
console.log("Input Array 1:", JSON.stringify(specialArray1, null, 2));
console.log("Input Array 2:", JSON.stringify(specialArray2, null, 2));
console.log("👉 Output:", JSON.stringify(unionResult7, null, 2), '\n');
...
console.log("Input Array 1:", JSON.stringify(mixedArray1, null, 2));
console.log("Input Array 2:", JSON.stringify(mixedArray2, null, 2));
console.log("👉 Output:", JSON.stringify(unionResult8, null, 2), '\n');
//------
// TASK 5---------------------------------------------
//------